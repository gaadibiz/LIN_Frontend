...
function ApplyNowContent() {
          ...
          <div className="min-h-screen bg-gray-50 flex flex-col py-10 px-4 items-center justify-center font-sans tracking-wide">
            ...
            <div className="max-w-[850px] w-full bg-white rounded-3xl shadow-xl p-8 lg:p-10 transition-all duration-500">
              <div className="flex flex-col items-center py-2 text-center fade-in">
                ...
                <h1 className="text-3xl font-bold text-[#14532d] mb-3">
                  Thank You!
                </h1>
                ...
                {appNumber && (
                  <div className="bg-[#f0fdf4] rounded-2xl flex items-center justify-center py-2 px-1 mb-8 mt-4 mx-auto inline-flex gap-3 pr-4 shadow-sm border border-green-100">
                    ...
                    <div className="flex flex-col text-left">
                      ...
                      <span className="text-[#14532d] font-black text-xl tracking-wide">
                        {appNumber}
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="flex flex-col items-start">
                      ...
                      <p className="text-[10px] text-gray-500 leading-relaxed">
                        We will review your details and documents.
                      </p>
                    </div>
                    <div className="flex flex-col items-start">
                      <div className="w-10 h-10 bg-white rounded-full flex items-center justify-center shadow-sm mb-3">
                      ...
                      <p className="text-[10px] text-gray-500 leading-relaxed">
                        You&apos;ll receive an update shortly via SMS or Email.
                      </p>
                    </div>
                    <div className="flex flex-col items-start">
                      <div className="w-10 h-10 bg-white rounded-full flex items-center justify-center shadow-sm mb-3">
                ...
                <div className="w-full bg-[#f0fdf4] rounded-2xl p-5 mb-8 text-left border border-[#dcfce7] flex flex-col sm:flex-row items-center justify-between gap-4">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <h4 className="text-sm font-bold text-[#14532d] mb-0.5">
                        Need Help or Have Questions?
                      </h4>
                      <p className="text-[10px] text-gray-600">
                        Chat with our customer care on WhatsApp.
                        <br />
                        Our virtual assistant is here to help you instantly!
                      </p>
                    </div>
                  </div>
                  <a
                    ...
                    className="bg-[#22c55e] hover:bg-[#16a34a] text-white text-xs font-bold py-3 px-4 rounded-lg flex items-center gap-2 whitespace-nowrap transition-colors">
                    <svg
                      className="w-4 h-4"
                      viewBox="0 0 24 24"
                      fill="currentColor">
                ...
                <div className="w-full mt-4 mb-6">
                  <button
                    ...
                    title={
                      !isProfileComplete
                        ? "Complete your profile (Name + PAN required) to access the dashboard"
                        : ""
                    }
                    ...
                    {isProfileComplete
                      ? "Go to Dashboard"
                      : "Complete Profile to Access Dashboard"}
                    <svg
                      className="w-5 h-5"
                      fill="none"
                      stroke="currentColor"
                  ...
                  {!isProfileComplete && (
                    <p className="text-center text-xs text-amber-600 font-medium mt-2">
                      ⚠️ Your profile is incomplete. Please verify your PAN and
                      provide your full name to access the dashboard.
                    </p>
                  )}
                </div>

                <p className="text-[10px] text-gray-400 font-medium">
                  We&apos;re here to make your loan journey simple and
                  hassle-free.
                </p>
              </div>
            </div>
    ...
    return (
        <div className="min-h-screen bg-gray-50 flex flex-col pt-34 pb-10 px-4 items-center justify-center font-sans tracking-wide">
            <div className="mb-6">
